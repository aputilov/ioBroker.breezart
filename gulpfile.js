...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Andrey Putilov';
    var email  = 'aputilov@hotmail.com';
    ...
    if (!newname) {
        console.log('Please write the new breezart name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/breezart.png')) {
        fs.renameSync(__dirname + '/admin/breezart.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/breezart.html')) {
        fs.renameSync(__dirname + '/widgets/breezart.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/breezart/js/breezart.js')) {
        fs.renameSync(__dirname + '/widgets/breezart/js/breezart.js', __dirname + '/widgets/breezart/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/breezart')) {
        fs.renameSync(__dirname + '/widgets/breezart',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /breezart/g,
        ...
        {
            match: /Breezart/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Breezart'
        },
        {
            match: /Andrey Putilov/g,
            replacement: author
        },
        {
            match: /aputilov@hotmail.com/g,
            replacement: email
        }
    ];
    var files = [
